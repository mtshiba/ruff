...
impl<'db> TypeVarInstance<'db> {
    ...
    #[salsa::tracked(cycle_initial=|db, id, _| Some(Type::recursive_initial(db, id)), cycle_fn=lazy_default_cycle_recover, heap_size=ruff_memory_usage::heap_size)]
...
impl<'db> BoundTypeVarInstance<'db> {
    ...
    pub(super) fn apply_type_mapping_impl<'a>(
        ...
        match type_mapping {
            ...
            | TypeMapping::UnfoldRecursive(_) => Type::TypeVar(self),
