...
/// Live bindings for a single lvalue at some point in control flow. Each live binding comes
...
pub(super) struct Bindings {
    ...
    /// A list of live bindings for this lvalue, sorted by their `ScopedDefinitionId`
...
/// One of the live bindings for a single lvalue at some point in control flow.
#[derive(Clone, Debug, PartialEq, Eq)]
...
impl Bindings {
    ...
    /// Record a newly-encountered binding for this lvalue.
    ...
    /// Iterate over currently live bindings for this lvalue
    pub(super) fn iter(&self) -> LiveBindingsIterator<'_> {
        self.live_bindings.iter()
    }

    /// Iterate over the IDs of each currently live binding for this lvalue
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(in crate::semantic_index) struct LValueState {
    declarations: Declarations,
    bindings: Bindings,
}

impl LValueState {
    /// Return a new [`LValueState`] representing an unbound, undeclared lvalue.
    ...
    /// control flow, but only if the set of live bindings or declarations for this lvalue hasn't
    /// changed.
    pub(super) fn simplify_visibility_constraints(&mut self, snapshot_state: LValueState) {
        self.bindings
    ...
    /// Record a newly-encountered declaration of this lvalue.
    pub(super) fn record_declaration(&mut self, declaration_id: ScopedDefinitionId) {
        self.declarations.record_declaration(declaration_id);
    }

    /// Merge another [`LValueState`] into this one.
    pub(super) fn merge(
        &mut self,
        b: LValueState,
        narrowing_constraints: &mut NarrowingConstraintsBuilder,
...
mod tests {
    ...
    #[track_caller]
    pub(crate) fn assert_declarations(symbol: &LValueState, expected: &[&str]) {
        let actual = symbol
            .declarations()
            .iter()
            .map(
    ...
    fn unbound() {
        ...
        let sym = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
    ...
    fn with() {
        let narrowing_constraints = NarrowingConstraintsBuilder::default();
        let mut sym = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
        sym.record_binding(
    ...
    fn merge() {
        ...
        let mut sym1a = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
        ...
        let mut sym1b = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
        ...
        let mut sym2a = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
        ...
        let mut sym3a = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
        ...
        let sym2b = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
    ...
    fn record_declaration_merge() {
        ...
        let mut sym2 = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
    ...
    fn record_declaration_merge_partial_undeclared() {
        ...
        let sym2 = LValueState::undefined(ScopedVisibilityConstraintId::ALWAYS_TRUE);
